...
export const Categories: EventType[] = [
  {
    title: "A New Innovation 2024",
    description:
  ...
  {
    title: "Researcher for Global",
    description:
      "A researcher dedicated to exploring and analyzing global trends",
    limit: 500,
    category: {
      name: "Environment",
